...
package com.vidiun.roughcut
{
	...
	import com.vidiun.roughcut.buffering.BufferMonitor;
	import com.vidiun.roughcut.buffering.events.BufferEvent;
	import com.vidiun.roughcut.events.RoughcutChangeEvent;
	import com.vidiun.roughcut.events.RoughcutStatusEvent;
	import com.vidiun.roughcut.interfaces.IRoughcut;
	import com.vidiun.roughcut.mediaclips.settings.MediaTypesSettings;
	import com.vidiun.roughcut.sdl.RoughcutSDL;
	...
	* @eventType com.vidiun.roughcut.buffering.events.BufferEvent.DOWNLOAD_COMPLETE
	*/
	[Event(name="downloadComplete", type="com.vidiun.roughcut.buffering.events.BufferEvent")]
	/**
	* Dispatched when the roughcut completed downloading the plugins.
	* @eventType com.vidiun.roughcut.buffering.events.BufferEvent.PLUGINS_DOWNLOAD_COMPLETE
	*/
	[Event(name="pluginsDownloadComplete", type="com.vidiun.roughcut.buffering.events.BufferEvent")]
	/**
	* Dispatched after the roughcut duration was changed.
	* @eventType com.vidiun.roughcut.events.RoughcutChangeEvent.ROUGHCUT_DURATION_CHANGE
	*/
	...
	* @eventType com.vidiun.roughcut.buffering.events.BufferEvent.ROUGHCUT_SOUNDTRACK_CHANGE
	*/
	...
	* @eventType com.vidiun.roughcut.events.RoughcutChangeEvent.FIRST_FRAME_LOADED
	*/
	 ...
	 * "create the mix" and generate the sdl representation of the Vidiun roughcut.
	 */
	public class Roughcut extends VidiunMixEntry implements IRoughcut
	{
		/**
		 ...
		 * @see com.vidiun.roughcut.mediaclips.settings.Roughcut.mediaTypesSettings
		 */
		 ...
		 */
		//xxx public var roughcutEditor:VidiunUser;
		/**
		...
		*/
		...
		public function get selectedSoundtrackEntry ():AbstractAsset
		{
			if (soundtrackAsset)
				...
				return VidiunApplication.nullAsset;
		}
		/**
		* whether this roughcut's soundtrack asset should play once or repeat untill video timeline finish.
		* @see com.vidiun.roughcut.soundtrack.AudioPlayPolicy#AUDIO_PLAY_POLICY_REPEAT
		* @see com.vidiun.roughcut.soundtrack.AudioPlayPolicy#AUDIO_PLAY_POLICY_ONCE
		* @see com.vidiun.roughcut.soundtrack.AudioPlayPolicy#AUDIO_PLAY_POLICY_ALL
		*/
		//xxx [Bindable(event="roughcutSoundtrackChange")]
		...
		* @see com.vidiun.roughcut.soundtrack.AudioPlayPolicy#CROSS_VIDEO_SILENT
		* @see com.vidiun.roughcut.soundtrack.AudioPlayPolicy#CROSS_VIDEO_MUTE
		* @see com.vidiun.roughcut.soundtrack.AudioPlayPolicy#CROSS_VIDEO_NO_ACTION
		*/
		//xxx [Bindable(event="roughcutSoundtrackChange")]
		...
		*/
		 ...
		 */
		public function Roughcut (mixEntry:VidiunMixEntry):void
		{
			super ();
		...
		private function copyEntryProperties (mixEntry:VidiunMixEntry):void
		{
		 ...
		 * @see com.vidiun.roughcut.assets.RoughcutTimelinesAssets
		 * @see com.vidiun.roughcut.events.RoughcutChangeEvent
		 */
...
/* 	xxx	public function entryStatusChange (event:PropertyChangeEvent):void
		{
			if (event.property != "status")
				return;
			var entry:VidiunPlayableEntry = event.currentTarget as VidiunPlayableEntry;
 ...
 */
		...
		private function createSolidAsset ():AbstractAsset
		{
			...
			var bd:BitmapData = new BitmapData (VidiunApplication.getInstance().initPlayerWidth,
								VidiunApplication.getInstance().initPlayerHeight, false, Roughcut.mediaTypesSettings.defaultSolidColor);
		 ...
		 *@see com.vidiun.roughcut.Roughcut#mediaTypesSettings
		 */
		...
		public function getMediaClipsByTypes (media_types:uint, addNullAsset:Boolean = false, nullAssetName:String = "nullAsset"):ArrayCollection
		{
			...
			if (addNullAsset)
			{
				asset = VidiunApplication.nullAsset;
		 ...
		 * @see com.vidiun.roughcut.mediaclips.sort.ISortOption
		 */
 ...
 */
		 ...
		 * @see com.vidiun.roughcut.mediaclips.filter.IFilterOption
		 */
...
*/
		...
		/**
		 *adds a new asset to the roughcut, apply to only vidiun assets (video, audio, images, solids...) and not plugins such as transitions, overlays or effects.
		 ...
		 */
		public function addPlugin (plugin:VidiunPluginInfo, time_stamp:Number, length_sec:Number = 5, timeline:uint = 0x2):uint
		{
		 ...
		 * @see com.vidiun.roughcut.Roughcut#setSoundtrackAsset
		 */
