This plugin makes sounds in response to VDP notifications it receives.
It is a demoplugin focusing on showing how to build a non visual VDP plugin.
The project holds a VDP swf in a debug mode under html-template folder, meaning you should be 
able to test your plugin without having to compile the VDP project.
